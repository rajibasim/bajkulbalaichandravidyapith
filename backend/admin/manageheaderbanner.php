...
if(isset($_REQUEST['action']) && $_REQUEST['action'] == 'add')
{
	...
	header("location:headerbanner.php?action=added");
}
...
if(isset($_REQUEST['action']) && $_REQUEST['action'] == 'edit')
{
	...
	header("location:headerbanner.php?action=updated");
}
?>
		   ...
		   <div class="span12">
			  ...
			  <div class="portlet box light-grey">
						...
						<div class="portlet-body form">
							...
							<input type="hidden" name="type" value="headerbanner">
						   ...
						   <div class="control-group" style="display: none;">
						    ...
						    <div class="control-group">
							  ...
							  <div class="controls">
								 <input type="text" class="span6 m-wrap" name="page_name" id="page_name" value="<?=isset($fetchdata->page_name) && $fetchdata->page_name ? stripslashes($fetchdata->page_name) : "";?>" />
							  </div>
						   </div>
