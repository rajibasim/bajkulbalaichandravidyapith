		...
		<div class="row-fluid">
		   <div class="span12">
			  ...
			  <div class="alert alert-success">
				...
				<strong>Success!</strong> headerbanner added
			  </div>
			  ...
			  <div class="alert alert-success">
				<button data-dismiss="alert" class="close"></button>
				<strong>Success!</strong> headerbanner updated
			  </div>
						...
						<div class="portlet-body">
							<div class="clearfix">
								<!-- <div class="btn-group">
									...
									<a class="btn mini green" href="manageheaderbanner.php?mode=add">Add New <i class="icon-plus"></i></a>
								...
								<div class="btn-group pull-right">
									...
									<ul class="dropdown-menu">
										<li><a onclick="delselected('data','headerbanner')" style="cursor:pointer">Delete Selected</a></li>
									</ul>
								</div> -->
							</div>
							<div id="tablesec">
							<table class="table table-striped table-bordered table-hover" id="sample_1">
								...
								<tbody>
									...
									<?php
									$getdest = "SELECT * FROM ".TABLE_PREFIX."data WHERE type = 'headerbanner' ORDER BY id DESC";
									...
									<tr class="odd gradeX">
										...
										<td class="hidden-480"><a class="btn mini green" data-toggle="modal" href="manageheaderbanner.php?data_id=<?=$rowdest['id']?>&mode=edit"><i class="icon-edit"></i> Edit</a></td>
										<!-- <td ><a class="btn mini red" href="#" onclick="deleteone(<?=$rowdest['id']?>,'data','headerbanner')"><i class="icon-trash"></i> Delete</a></td> -->
									</tr>
