...
if(isset($getdata['json_data']) && $getdata['json_data'])
{
...
if(isset($_REQUEST['action']) && $_REQUEST['action'] == 'add')
{
	...
	header("location:facuilty.php?action=added");
}
...
if(isset($_REQUEST['action']) && $_REQUEST['action'] == 'edit')
{
	...
	header("location:facuilty.php?action=updated");
}
?>
		   ...
		   <div class="span12">
			  ...
			  <div class="portlet box light-grey">
						...
						<div class="portlet-body form">
							...
							<input type="hidden" name="type" value="facuilty">
						   ...
						   <div class="control-group">
							  ...
							  <div class="controls">
								 <input type="text" class="span6 m-wrap" name="designation" id="designation" value="<?=isset($fetchdata->designation) && $fetchdata->designation ? stripslashes($fetchdata->designation) : "";?>" />
							  </div>
						   </div>
						   <div class="control-group">
							  <label class="control-label">Degree</label>				  
							  <div class="controls">
								 <input type="text" class="span6 m-wrap" name="degree" id="degree" value="<?=isset($fetchdata->degree) && $fetchdata->degree ? stripslashes($fetchdata->degree) : "";?>" />
							  </div>
						   </div>
